...
public record CreateCouponRequest(
    ...
    @NotNull @Min(1) @Max(99) CouponDiscountRate couponDiscountRate,
    @NotNull @Min(1) Integer couponQuantity,
    @NotNull @FutureOrPresent(message = "쿠폰 발급 시작일은 오늘 이후여야 합니다.") CouponStartDate couponStartDate,
    @NotNull CouponEndDate couponEndDate,
    @NotNull CouponExpiredDate couponExpiredDate,
